...
public class BasicKeys {
	...
	public static void zeroNumerico() {
		InputManager.digitar(KeyEvent.VK_NUMPAD0);
		// System.out.println(new Object() {
		// }.getClass().getEnclosingMethod().getName());
	}
	...
	public static void doisNumerico() {
		InputManager.digitar(KeyEvent.VK_NUMPAD2);
		// System.out.println(new Object() {
		// }.getClass().getEnclosingMethod().getName());
	}

	public static void tresNumerico() {
		InputManager.digitar(KeyEvent.VK_NUMPAD3);
		// System.out.println(new Object() {
		// }.getClass().getEnclosingMethod().getName());
	}

	public static void quatroNumerico() {
		InputManager.digitar(KeyEvent.VK_NUMPAD4);
		// System.out.println(new Object() {
		// }.getClass().getEnclosingMethod().getName());
	}

	public static void cincoNumerico() {
		InputManager.digitar(KeyEvent.VK_NUMPAD5);
		// System.out.println(new Object() {
		// }.getClass().getEnclosingMethod().getName())
	}

	public static void seisNumerico() {
		InputManager.digitar(KeyEvent.VK_NUMPAD6);
		// System.out.println(new Object() {
		// }.getClass().getEnclosingMethod().getName());
	}

	public static void seteNumerico() {
		InputManager.digitar(KeyEvent.VK_NUMPAD7);
		// System.out.println(new Object() {
		// }.getClass().getEnclosingMethod().getName());
	}

	public static void oitoNumerico() {
		InputManager.digitar(KeyEvent.VK_NUMPAD8);
		// System.out.println(new Object() {
		// }.getClass().getEnclosingMethod().getName());
	}

	public static void noveNumerico() {
		InputManager.digitar(KeyEvent.VK_NUMPAD9);
		// System.out.println(new Object() {
		// }.getClass().getEnclosingMethod().getName());
	}
